...
<div class="row mb-8 p-5">
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control gui-input" id="title_ar_inp" name="title_ar"
                value="{{ old('title_ar', $award->title_ar) }}" autocomplete="off" required />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control gui-input" id="title_en_inp" name="title_en"
                value="{{ old('title_en', $award->title_en) }}" autocomplete="off" required />
...
<div class="row mb-8 p-5">
    ...
    <div class="col-md-6 fv-row">
        ...
        <label class="fs-5 fw-bold mb-2 required"
            for="kt_docs_ckeditor_classic2">{{ __('Description English') }}</label>
        <div class="py-5" data-bs-theme="light" style="color: #000">
...
<div class="row mb-8 p-5">
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="number" class="form-control" id="point_inp" name="point"
                value="{{ old('point', $award->point) }}" autocomplete="off" required />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="file" class="form-control" multiple id="images_inp" name="images[]"
                @if (!request()->segment(4) == 'edit') required @endif autocomplete="off" />
