    ...
    <div class="d-flex justify-content-between flex-sm-row mb-5 flex-col align-items-center">
        <div class="col-auto">
            @component('components.dashboard.breadcrumb')
                @slot('breadcrumb_title')
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Awards') }}</h1>
                    <!-- end   :: Title -->
                @endslot
                <!-- begin :: Item -->
        ...
        <div class="d-flex col-auto  align-items-cener m-0 flex-wrap  ">
            ...
            <div class="d-flex justify-content-end align-items-center" data-kt-docs-table-toolbar="base">
                @can('create_awards')
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.awards.create') }}"class="btn my-gold p-1 pe-0" data-bs-toggle="tooltip"
                        title="">
