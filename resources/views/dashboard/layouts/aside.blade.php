        ...
        <div class="w-100 hover-scroll-overlay-y my-sidebar-nav d-flex pe-2" id="kt_aside_menu_wrapper"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto"
                ...
                <div class="menu-link {{ Route::currentRouteName() === 'dashboard.stand-ups.index' ? 'active' : '' }} {{ Route::currentRouteName() === 'dashboard.stand-ups.create' ? 'active' : '' }} "
                    ...
                    <div class="dropdown-content absolute">
                        <a href="{{ route('dashboard.stand-ups.index') }}"
                            class="with-border">{{ __('Stand Ups') }}</a>
                        <a href="{{ route('dashboard.stand-ups.create') }}">{{ __('Add New Stand Up') }}</a>
                    </div>
                </div>
