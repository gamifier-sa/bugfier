            ...
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{prefixHoverShow('admins')}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <!--begin:Menu item-->
                        <div class="menu-item {{prefixShow('dashboard.admins.index')}}">
                            @can('view_admins')
                            <!--begin:Menu link-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{prefixHoverShow('projects')}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        @can('view_projects')
                        <!--begin:Menu item-->
                        <div class="menu-item {{prefixShow('dashboard.projects.index')}}">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('dashboard.projects.index') }}" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{prefixHoverShow('bugs')}}">
                    ...
                    <span class="menu-link">
                        ...
                        <span class="menu-title">{{__('Bugs')}}</span>
                        <span class="menu-arrow"></span>
                    </span><!--end:Menu link-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        @can('view_bugs')
                        <!--begin:Menu item-->
                        <div class="menu-item {{prefixShow('dashboard.bugs.index')}}">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('dashboard.bugs.index') }}" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{prefixHoverShow('awards')}}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        @can('view_awards')
                        <!--begin:Menu item-->
                        <div class="menu-item {{prefixShow('dashboard.awards.index')}}">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('dashboard.awards.index') }}" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{prefixHoverShow('statuses')}}">
                    ...
                    <span class="menu-link">
                        ...
                        <span class="menu-title">{{__('Statuses')}}</span>
                        <span class="menu-arrow"></span>
                    </span><!--end:Menu link-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        @can('view_statuses')
                        <!--begin:Menu item-->
                        <div class="menu-item {{prefixShow('dashboard.statuses.index')}}">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('dashboard.statuses.index') }}" data-bs-toggle="tooltip"
                                data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
...
{{--                    <!--end::Menu item-->--}}
                    ...
                    <div class="menu-item px-5">
                        <form id="logout-form" method="post" action="{{ route('admin.logout') }}">
                            @csrf
                            <button onclick="return confirm('{{__('Are you sure to logout')}}');" onclick="$('#logout-form').submit()" class="menu-link btn px-5">{{__("Sign Out")}}</button>
                        </form>
                    </div>
                    <!--end::Menu item-->
                </div>
