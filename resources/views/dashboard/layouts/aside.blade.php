...
<div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
 ...
 <a class="nav-btn " href="{{ route('dashboard.home') }}">
        ...
        <!--begin::Aside Menu-->
        <div class="w-100 hover-scroll-overlay-y my-sidebar-nav d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu, #kt_aside_menu_wrapper" data-kt-scroll-offset="100">
            <!--begin::Menu-->
...
<div class="menu-link {{ Route::currentRouteName() === 'dashboard.roles.index' ? 'active' : '' }}">
        <a class="nav-link " href="{{ route('dashboard.roles.index') }}">
          <i>
           <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
  <path d="M29.1667 14C29.1667 8.16668 26.8333 5.83334 21 5.83334H14C8.16666 5.83334 5.83333 8.16668 5.83333 14V21C5.83333 26.8333 8.16666 29.1667 14 29.1667" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M23.8437 11.6667C23.0417 10.6458 21.7 10.2083 19.6875 10.2083H15.3125C11.6667 10.2083 10.2083 11.6667 10.2083 15.3125V19.6875C10.2083 21.7 10.6458 23.0417 11.6521 23.8438" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.6812 5.83332V2.91666" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M17.5 5.83332V2.91666" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M23.3333 5.83332V2.91666" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M29.1667 11.6667H32.0833" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.6812 29.1667V32.0833" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2.91666 11.6667H5.83332" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2.91666 17.5H5.83332" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2.91666 23.3333H5.83332" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M24.3688 27.1104C25.6494 27.1104 26.6875 26.0723 26.6875 24.7917C26.6875 23.511 25.6494 22.4729 24.3688 22.4729C23.0881 22.4729 22.05 23.511 22.05 24.7917C22.05 26.0723 23.0881 27.1104 24.3688 27.1104Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M16.6396 25.4625V24.1063C16.6396 23.3042 17.2958 22.6479 18.0979 22.6479C19.4979 22.6479 20.0667 21.6563 19.3667 20.4458C18.9583 19.7458 19.2063 18.8417 19.9063 18.4479L21.2333 17.675C21.8458 17.3104 22.6333 17.5292 22.9979 18.1417L23.0854 18.2875C23.7854 19.4979 24.9229 19.4979 25.6229 18.2875L25.7104 18.1417C26.075 17.5292 26.8625 17.325 27.475 17.675L28.8021 18.4479C29.5021 18.8563 29.75 19.7458 29.3417 20.4458C28.6417 21.6563 29.2104 22.6479 30.6104 22.6479C31.4125 22.6479 32.0688 23.3042 32.0688 24.1063V25.4625C32.0688 26.2646 31.4125 26.9208 30.6104 26.9208C29.2104 26.9208 28.6417 27.9125 29.3417 29.1229C29.75 29.8229 29.5021 30.7271 28.8021 31.1208L27.475 31.8938C26.8625 32.2583 26.075 32.0396 25.7104 31.4271L25.6229 31.2813C24.9229 30.0708 23.7854 30.0708 23.0854 31.2813L22.9979 31.4271C22.6333 32.0396 21.8458 32.2438 21.2333 31.8938L19.9063 31.1208C19.2063 30.7125 18.9583 29.8229 19.3667 29.1229C20.0667 27.9125 19.4979 26.9208 18.0979 26.9208C17.2958 26.9354 16.6396 26.2792 16.6396 25.4625Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</i>
...
<div class="menu-link {{ Route::currentRouteName() === 'dashboard.levels.index' ? 'active' : '' }}">
...
<div class="menu-link {{ Route::currentRouteName() === 'dashboard.bugs.index' ? 'active' : '' }}">
        <a class="nav-link " href="{{ route('dashboard.bugs.index') }}">
          <i>
       <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
  <path d="M11.25 16.25C10.425 16.6625 9.73751 17.275 9.22501 18.0375C8.93751 18.475 8.93751 19.025 9.22501 19.4625C9.73751 20.225 10.425 20.8375 11.25 21.25" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M19.0125 16.25C19.8375 16.6625 20.525 17.275 21.0375 18.0375C21.325 18.475 21.325 19.025 21.0375 19.4625C20.525 20.225 19.8375 20.8375 19.0125 21.25" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2.5 16.25V18.75C2.5 25 5 27.5 11.25 27.5H18.75C25 27.5 27.5 25 27.5 18.75V11.25C27.5 5 25 2.5 18.75 2.5H11.25C5 2.5 2.5 5 2.5 11.25" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M2.78749 10.0125L26.8125 10" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</i>
          <span>Bugs</span>
        </a>
...
<div class="menu-link {{ Route::currentRouteName() === 'dashboard.awards.index' ? 'active' : '' }}">
        <a class="nav-link " href="{{ route('dashboard.awards.index') }}">
          <i>
     <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
  <path d="M24.9625 12.5H4.96249V22.5C4.96249 26.25 6.21249 27.5 9.96249 27.5H19.9625C23.7125 27.5 24.9625 26.25 24.9625 22.5V12.5Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M26.875 8.75V10C26.875 11.375 26.2125 12.5 24.375 12.5H5.625C3.7125 12.5 3.125 11.375 3.125 10V8.75C3.125 7.375 3.7125 6.25 5.625 6.25H24.375C26.2125 6.25 26.875 7.375 26.875 8.75Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M14.55 6.25H7.65001C7.22501 5.7875 7.23751 5.075 7.68751 4.625L9.46251 2.85C9.92501 2.3875 10.6875 2.3875 11.15 2.85L14.55 6.25Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M22.3375 6.25H15.4375L18.8375 2.85C19.3 2.3875 20.0625 2.3875 20.525 2.85L22.3 4.625C22.75 5.075 22.7625 5.7875 22.3375 6.25Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.175 12.5V18.925C11.175 19.925 12.275 20.5125 13.1125 19.975L14.2875 19.2C14.7125 18.925 15.25 18.925 15.6625 19.2L16.775 19.95C17.6 20.5 18.7125 19.9125 18.7125 18.9125V12.5H11.175Z" stroke="currentColor" stroke-width="2.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</i>
          <span>awards</span>
        </a>
...
<div class="menu-link {{ Route::currentRouteName() === 'dashboard.statuses.index' ? 'active' : '' }}">
        <a class="nav-link " href="{{ route('dashboard.statuses.index') }}">
          <i>
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
  <path d="M19.1567 9.27501C22.0033 12.1217 22.0033 16.7417 19.1567 19.5883C16.31 22.435 11.69 22.435 8.84334 19.5883C5.99668 16.7417 5.99668 12.1217 8.84334 9.27501C11.69 6.42834 16.31 6.42834 19.1567 9.27501Z" fill="currentColor"/>
  <path d="M9.62502 26.1217C9.52002 26.1217 9.40335 26.0983 9.29835 26.0633C6.67335 25.0133 4.55002 23.1583 3.12668 20.7083C1.75002 18.3167 1.20168 15.61 1.56335 12.8567C1.62168 12.3783 2.07668 12.04 2.54335 12.0983C3.02168 12.1567 3.36002 12.6 3.30168 13.0783C2.99835 15.4467 3.46502 17.78 4.64335 19.8333C5.85668 21.9333 7.68835 23.5317 9.94002 24.43C10.3833 24.6167 10.605 25.1183 10.43 25.5733C10.3017 25.9117 9.96335 26.1217 9.62502 26.1217Z" fill="currentColor"/>
  <path d="M6.825 6.10166C6.56833 6.10166 6.31166 5.98499 6.13666 5.76333C5.83333 5.38999 5.90333 4.84166 6.28833 4.53833C8.50499 2.79999 11.1767 1.87833 14 1.87833C16.7533 1.87833 19.3783 2.76499 21.5833 4.44499C21.9683 4.73666 22.0383 5.28499 21.7467 5.66999C21.455 6.05499 20.9067 6.12499 20.5217 5.83333C18.62 4.38666 16.3683 3.62833 14 3.62833C11.5733 3.62833 9.27499 4.42166 7.36166 5.91499C7.19833 6.04333 7.01166 6.10166 6.825 6.10166Z" fill="currentColor"/>
  <path d="M18.375 26.1217C18.025 26.1217 17.6983 25.9117 17.5583 25.5733C17.3833 25.13 17.5933 24.6167 18.0483 24.43C20.3 23.52 22.1317 21.9333 23.345 19.8333C24.535 17.78 25.0017 15.4467 24.6867 13.09C24.6283 12.6117 24.9667 12.1683 25.445 12.11C25.9117 12.0517 26.3667 12.39 26.425 12.8683C26.775 15.61 26.2383 18.3283 24.8617 20.72C23.45 23.17 21.315 25.0133 18.69 26.075C18.5967 26.0983 18.4917 26.1217 18.375 26.1217Z" fill="currentColor"/>
</svg>
</i>
          <span>statuses</span>
        </a>
        ...
        <!--end::User panel-->
          <div class="menu-item my-logout-form ">
                        <form id="logout-form" method="post" action="{{ route('admin.logout') }}">
                            @csrf
                            <button onclick="return confirm('{{__('Are you sure to logout')}}');" onclick="$('#logout-form').submit()" class="menu-link logout-btn btn px-5">   <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
  <path d="M12.1667 5.83314L8 9.99981L12.1667 14.1665" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M8 9.99982L18 9.99982" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M8 17.4998H4.66667C4.22464 17.4998 3.80072 17.3242 3.48816 17.0117C3.1756 16.6991 3 16.2752 3 15.8332L3 4.16648C3 3.72446 3.1756 3.30053 3.48816 2.98797C3.80072 2.67541 4.22464 2.49982 4.66667 2.49982H8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
