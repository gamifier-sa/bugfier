    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control gui-input" id="title_ar_inp" name="title_ar"
                value="{{ old('title_ar', $project->title_ar) }}" autocomplete="off" required />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control gui-input" id="title_en_inp" name="title_en"
                value="{{ old('title_en', $project->title_en) }}" autocomplete="off" required />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="col-md-12 fv-row">
            <label class="fs-5 fw-bold mb-2 required"
                for="kt_docs_ckeditor_classic">{{ __('Description Arabic') }}</label>
