...
@endpush
@section('title') {{__("Level list")}} @endsection
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    @can('create_levels')
                        <!-- begin :: Add Button -->
                        <a href="{{ route('dashboard.levels.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
...
@push('scripts')
    <script>
        ...
        let authorizationUpdate = @can('update_levels') 'true' @else '' @endcan;
        let authorizationDelete = @can('delete_levels') 'true' @else '' @endcan;
        let authorizationShow   = @can('show_levels') 'true' @else '' @endcan
    </script>
