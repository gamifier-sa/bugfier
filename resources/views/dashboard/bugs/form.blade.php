...
<div class="row mb-8 p-5">
    ...
    <div class="col-md-12 fv-row">
        ...
        <select class="form-control select-2-with-image" data-control="select2" name="project_id" id="project_id_inp"
...
<div class="row mb-8 p-5">
    ...
    <div class="col-md-12 fv-row">
        ...
        <div class="form-floating">
            <input type="text" class="form-control gui-input" id="title_inp" name="title"
                value="{{ old('title', $bug->title) }}" autocomplete="off" required />
...
<div class="row mb-8 p-5">
    @can('update_point_bugs')
        ...
        <div class="col-md-6 fv-row">
            ...
            <div class="form-floating">
                <input type="number" class="form-control" id="point_inp" name="point"
                    value="{{ old('point', $bug->point) }}" autocomplete="off" />
    ...
    <div class="col-md-6 fv-row">
        ...
        <div class="form-floating">
            <input type="file" class="form-control" multiple id="images_inp"
                @if (!request()->segment(4) == 'edit') required @endif name="images[]" autocomplete="off" />
...
<div class="row mb-8 p-5">
    @can('responsible_admin_bugs')
        @if (request()->segment(4) == 'edit')
            ...
            <div class="col-md-6 fv-row">
                ...
                <select class="form-control select-2-with-image" data-control="select2" name="responsible_admin"
                    id="responsible_admin_inp" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                    <option selected disabled>{{ __('Please Choose') }}</option>
    ...
    <div class="col-md-6 fv-row">
        ...
        <select class="form-control select-2-with-image" data-control="select2" name="status_id" id="status_id"
            data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
            <option selected disabled>{{ __('Please Choose') }}</option>
