...
@section('content')
    ...
    @component('components.dashboard.breadcrumb')
        ...
        @endslot
        <!-- begin :: Item -->
        <li class="breadcrumb-item text-muted">{{__('Edit An Bugs')}}</li><!-- end   :: Item -->
    @endcomponent
    ...
    <div class="card  mb-5 mb-xl-10">
        ...
        <div class="card-body">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.bugs.update', $bug->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.bugs.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
