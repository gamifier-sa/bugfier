...
@section('content')
    @component('components.dashboard.breadcrumb')
        @slot('breadcrumb_title')
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.bugs.index') }}"
                    class="text-muted text-hover-primary">{{ __('Bugs') }}</a></h1><!-- end   :: Title -->
        @endslot
        <!-- begin :: Item -->
    ...
    <div class=" mb-5 mb-xl-10">
        ...
        <div class="mt-10">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.bugs.store') }}" class="form" method="post" id="submitted-form"
