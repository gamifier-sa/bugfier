                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5" data-kt-docs-table-filter="form">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold" name="status_id" data-kt-select2="true" data-placeholder="{{__('Please Choose')}}" data-allow-clear="true" data-kt-docs-table-filter="search" data-hide-search="true" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    <option></option>
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold" name="created_by" data-kt-select2="true" data-placeholder="{{__('Please Choose')}}" data-allow-clear="true" data-kt-docs-table-filter="search" data-hide-search="true" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    <option></option>
...
@push('scripts')
    <script>
        ...
        let authorizationUpdateExp = @can('update_exp_bugs') 'true' @else '' @endcan;
