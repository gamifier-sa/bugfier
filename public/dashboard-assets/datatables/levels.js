        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/levels?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
                        ...
                        if (authorizationUpdate && authorizationDelete) {
                            return `
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="/dashboard/levels/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                    ...
                                    <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${row.id}" data-type="${translate('level')}">
                            ...
                            if (authorizationUpdate) {
                                ...
                                <div class="btn btn-light btn-active-light-primary btn-sm">
                                    <a href="/dashboard/levels/${ row.id }/edit" class="menu-link px-3 d-flex edit-row" >
                                       <span> ${translate('Edit')} </span>
                                    </a>
                                </div><!--end::Menu-->
                            `;
