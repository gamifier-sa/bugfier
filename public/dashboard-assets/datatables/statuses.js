        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if (row.is_default === 1) {
                            return `<td> <div class='d-flex my-td-inner align-items-center justify-center for-date'>    <svg class="theme-light-show" width="24" height="24" viewBox="0 0 24 24" fill="success" xmlns="http://www.w3.org/2000/svg">
                            ...
                            return `<td> <div class='d-flex my-td-inner align-items-center justify-center for-date'>    <svg class="theme-dark-show" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
