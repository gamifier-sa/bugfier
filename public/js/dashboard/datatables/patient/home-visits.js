        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/patients/home-visits?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        if(row.status === 'accepted') {
                            return `<span class="badge badge-light-success">${translate('Accepted')}</span>`;
                        } else if (row.status === 'pending') {
                            return `<span class="badge badge-light-danger">${translate('Pending')}</span>`;
                        } else if (row.status === 'finished') {
                            return `<span class="badge badge-light-info">${translate('Finished')}</span>`;
                        }
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/patients/home-visits/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                ...
                                <!--
                                <div class="menu-item px-3">
                                    <a href="/patients/home-visits/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
            ...
            deleteAlert(type).then(function (result) {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: '/patients/home-visits/' + rowId,
                        success: () => {
